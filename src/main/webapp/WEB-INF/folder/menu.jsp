    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="${pageContext.request.contextPath}/about.jsp">Action</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/about.jsp">Another action</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/about.jsp">Something else here</a>
        </div>
      </li>
    </ul>
